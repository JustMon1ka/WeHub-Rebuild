...
import ReportUserButton from '@/modules/user/components/UserPage/ReportUserButton.vue'
  ...
  <div>
    ...
    <div class="h-72 bg-slate-700">
      <img
        ...
        v-bind:src="userInfo.profileUrl"
        class="w-full h-full object-cover"
        alt="Profile banner"
      />
      <img
        v-else
        src="@/modules/user/assets/default_background.svg"
        class="w-full h-full object-cover"
        alt="Profile banner"
      />
    </div>
    ...
    <div class="px-4 -mt-16">
      <div class="flex justify-between items-end">
        ...
        <div class="flex items-center gap-3">
          ...
          <template v-else>
            <FollowButton
              :user-id="userInfo.userId.toString()"
              class="w-24"
              @followed="userInfo.followerCount += 1"
              @unfollowed="userInfo.followerCount -= 1"
            />
            <ReportUserButton :user-id="userInfo.userId.toString()" />
          </template>
        </div>
      </div>
    </div>
    ...
    <div class="p-4">
      ...
      <div class="flex items-center space-x-4 mt-4 text-slate-500 text-sm"></div>
